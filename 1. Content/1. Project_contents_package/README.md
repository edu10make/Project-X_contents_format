...
미션을 달성했을 때 달성할 수 있는 역량을 경험을 중심으로 기술합니다.</br></br>

따라서 각 항목은 PSI에서 제공하는 **tech skill 역량명세서 - 경험리스트**를 참고하여 기술합니다.</br></br>

tech skill 역량명세서 - 경험리스트**의 항목 중 해당 미션 수행 후 달성할 수 있는 역량을 찾아 해당 역량의 no**를 `숫자`로 기술합니다.
