...
### 개요
- 프로젝트의 id, 주제, 목적 등 프로젝트의 기본적인 정보를 기입합니다. 
...
프로젝트를 구분하기 위해 각 프로젝트의 고유 번호를 입력합니다.
...
"title": "미터기 읽기"
```
- 해당 프로젝트의 이름은 '미터기 읽기'입니다. 

## 1.3 estimation_time

프로젝트를 수행하는데 예상되는 소요 시간을 작성합니다. 
- `int형 정수`로 입력하며 기본 단위는 '일'입니다. 
- 실제로 해당 프로젝트를 학생들에게 학습시킬 때, 예상 소요 시간을 참고하여 프로젝트 수행 기간을 설정할 수 있습니다. 
